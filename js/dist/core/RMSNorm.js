 ...
 */
export function rmsNorm(x, weight, seqLen, dim) {
 ...
 */
export function rmsNormSingle(x, weight) {
    const dim = x.length;
 ...
 */
export function rmsNormSingleInto(x, weight, output) {
    const dim = x.length;
    // Compute RMS
    let sumSq = 0;
    for (let d = 0; d < dim; d++) {
...
//# sourceMappingURL=RMSNorm.js.map